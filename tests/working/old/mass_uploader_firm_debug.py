...
def recreate_assets_with_new_firmware(client: IcareApiClient, server_data: List[Dict]):
    ...
    recreation of Gateways to update firmware, using a robust copy-and-clean method.
    """
    print("\n--- Starting Final Firmware Update Process (Copy-and-Clean Method) ---")
    ...
    for asset_summary in assets_to_recreate:
        ...
        if asset_type == "Transmitter":
            ...
            try:
                # 1. Get full info and prepare clean channel payloads
                print("  [1/6] Storing full channel info...")
                old_transmitter_full = client.get_asset(asset_id)
                stored_channel_payloads = []
                for channel in old_transmitter_full.get('channels', []):
                    # Use the robust copy-and-clean method for channels
                ...
                # 5. Create new transmitter using the robust copy-and-clean method
                print("  [5/6] Creating new transmitter with all settings preserved...")
                new_transmitter_payload = copy.deepcopy(old_transmitter_full)
                # Clean all system keys AND the problematic 'channels' key
            ...
            try:
                ...
                # Use copy-and-clean for the gateway
                ...
                print("  [1/2] Creating new gateway with all settings preserved...")
